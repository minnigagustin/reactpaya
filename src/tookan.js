      ...
      <tbody>
        {this.state.data.map(empresa=>{
          ...
          <td>
                ...
                |  
                <button className="btn btn-success" onClick={()=>{this.seleccionarNoti(empresa);}}>N</button>
    ...
    <Modal isOpen={this.state.modalInsertar} centered={true}>
          ...
          <Modal isOpen={this.state.modalEliminar} centered={true}>
            ...
            <div className="form-group">
                    ...
                    <input className="form-control" type="number" inputmode="numeric" name="total" id="total"  onChange={this.handleChangeNoti} value={this.state.total? this.state.total : ''}/>
