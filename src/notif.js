  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <br />
        <Container>
        <input className="form-control" type="text"name="total" id="total" placeholder="Texto" onChange={this.handleChange}/>
        <br />
        <button className="btn btn-success" style={{ width: '100%' }} onClick={() => this.noti()} >
          Notificacion
        </button>
</Container>
