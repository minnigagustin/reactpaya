    ...
    for (let i = 0; i < result.length; i++) {
     ...
     console.log(result[i])
      ...
      if (orderDistance === 'null') {
        ...
        axios.post(urlpre, datopre, headers).then(response => {
          console.log(response.data.data.estimated_fare);
            ...
            const datowallet = {
              ...
              "amount": (response.data.data.estimated_fare - 2.50),
              "transaction_type": 2,
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <button className="btn btn-success" style={{ width: '98%' }} onClick={() => this.peticionPrimera()} >
          Actualizar
        </button>
